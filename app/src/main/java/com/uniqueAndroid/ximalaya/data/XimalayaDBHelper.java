...
public class XimalayaDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String subTbSQL = "create table " + Constants.SUB_TB_NAME + "(" + Constants.SUB_ID + " integer," + Constants.SUB_COVER_URL + " varchar," + Constants.SUB_TITLE + " varchar," + Constants.SUB_DESCRIPTION + " varchar," + Constants.SUB_PLAY_COUNT + " integer," + Constants.SUB_TB_TRACK_COUNT + " integer," + Constants.SUB_AUTHOR_NAME + " varchar," + Constants.SUB_ALBUM_ID + " integer);\n";
        db.execSQL(subTbSQL);
    }
